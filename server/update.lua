...
local resourceName = "sc_licensemanager"
...
function GetRepoInformations()
    ...
    PerformHttpRequest("https://api.github.com/repos/ScubeScripts/sc_licensemanager/releases/latest", function(err, response)
        if err == 200 then
            ...
            repoURL = "https://github.com/ScubeScripts/sc_licensemanager"
        end
    end, "GET")
    repeat
        Wait(50)
...
CreateThread(function()
    if GetCurrentResourceName() ~= "sc_licensemanager" then
        resourceName = "sc_licensemanager (" .. GetCurrentResourceName() .. ")"
    end
